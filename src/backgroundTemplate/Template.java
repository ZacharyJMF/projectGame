...
public class Template implements GameLoop {
    ...
    public void init() {
        ...
        rooms[1]=new BackgroundScene("resources/2.png"); // Room image
        ...
        rooms[2]=new BackgroundScene("resources/3.png"); // Room image
        ...
        rooms[3]=new BackgroundScene("resources/bat.jpeg"); // Room image
        ...
        clickTime=0; // Initialize clickTime
    }
    ...
    public void mouseEvent(MouseEvent mouseEvent) {
        ...
        if (currentTime - clickTime > 300) { // 300ms debounce time
            ...
            // Display clicked position with a red square
            SaxionApp.setFill(Color.RED);
            SaxionApp.drawRectangle(mouseX - 25, mouseY - 25, 50, 50);
